...
//
//  gcc -Wall -Werror -std=c11 -pedantic -o 06_main.exe 06_main.c 06_libby2.c 06_libby3.c
//
...
//  gcc -Wall -Werror -std=c11 -pedantic -c 06_main.c
//  gcc -Wall -Werror -std=c11 -pedantic -c 06_libby2.c
//  gcc -Wall -Werror -std=c11 -pedantic -c 06_libby3.c
//
// 2) y luego linkear los objetos:
//  gcc -Wall -Werror -std=c11 -pedantic -o 06_main.exe 06_main.o 06_libby2.o 06_libby3.o
//
...
//  gcc -Wall -Werror -std=c11 -pedantic -c 06_libby2.c 06_libby3.c
...
//  gcc -Wall -Werror -std=c11 -pedantic -o 06_main.exe 06_main.c lib06_lib.a
//
...
//
// 2) y luego compilar el resto del proyecto y linkear con la lib
//  gcc -Wall -Werror -std=c11 -pedantic -o 06_main.exe 06_main.c -l06_lib
//
...
//  gcc -Wall -Werror -std=c11 -pedantic -L./ -o 06_main.exe 06_main.c -l06_lib
//
...
//  gcc -Wall -Werror -std=c11 -pedantic -L./ -o 06_main.exe   06_main.c   -l06_lib
// pero esto no:
//  gcc -Wall -Werror -std=c11 -pedantic -L./ -o 06_main.exe    -l06_lib   06_main.c
//
